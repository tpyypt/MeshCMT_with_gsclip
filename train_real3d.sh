...
epoch1=15
epoch2=10
times="Real3D_run1" # 给这次实验起个独立的名字，避免和之前的覆盖

# Real3D-AD 数据集要跑的类别列表，这里列出了原代码中的三个类别，你可以根据需要增删
obj_list=('shell' 'starfish' 'seahorse')
cls_ids=(0 1 2)

# 设置为你提供的新数据集路径
DATA_PATH="/data/zkl/GS-dataset/Real3D-AD"
